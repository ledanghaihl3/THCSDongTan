  ...
  const handleSaveConfig = async (e) => {
    ...
    try {
      ...
      const [pAv, vpAv, t1Av, t2Av, t3Av, t4Av] = await Promise.all([
        uploadBase64ToSupabase(configState.principalAvatar).then(url => url || configState.principalAvatar || 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=200&q=80'),
        uploadBase64ToSupabase(configState.vicePrincipalAvatar).then(url => url || configState.vicePrincipalAvatar || 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=200&q=80'),
        uploadBase64ToSupabase(configState.teamLeader1Avatar).then(url => url || configState.teamLeader1Avatar || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=200&q=80'),
        uploadBase64ToSupabase(configState.teamLeader2Avatar).then(url => url || configState.teamLeader2Avatar || 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=200&q=80'),
        uploadBase64ToSupabase(configState.teamLeader3Avatar).then(url => url || configState.teamLeader3Avatar || 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80'),
        uploadBase64ToSupabase(configState.teamLeader4Avatar).then(url => url || configState.teamLeader4Avatar || 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=200&q=80')
      ]);
