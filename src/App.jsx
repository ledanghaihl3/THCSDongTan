      ...
      if (cfgData) {
        setSiteConfig(prev => {
          const merged = {
            ...
            teamLeader1Name: cfgData.team_leader_1_name || cfgData.team_leader_1 || prev.teamLeader1Name || INITIAL_SITE_CONFIG.teamLeader1Name,
            teamLeader1Title: cfgData.team_leader_1_title || prev.teamLeader1Title || INITIAL_SITE_CONFIG.teamLeader1Title,
            teamLeader1Avatar: cfgData.team_leader_1_avatar || prev.teamLeader1Avatar || INITIAL_SITE_CONFIG.teamLeader1Avatar,
            teamLeader2Name: cfgData.team_leader_2_name || cfgData.team_leader_2 || prev.teamLeader2Name || INITIAL_SITE_CONFIG.teamLeader2Name,
            teamLeader2Title: cfgData.team_leader_2_title || prev.teamLeader2Title || INITIAL_SITE_CONFIG.teamLeader2Title,
            teamLeader2Avatar: cfgData.team_leader_2_avatar || prev.teamLeader2Avatar || INITIAL_SITE_CONFIG.teamLeader2Avatar,
            teamLeader3Name: cfgData.team_leader_3_name || cfgData.team_leader_3 || prev.teamLeader3Name || INITIAL_SITE_CONFIG.teamLeader3Name,
            teamLeader3Title: cfgData.team_leader_3_title || prev.teamLeader3Title || INITIAL_SITE_CONFIG.teamLeader3Title,
            teamLeader3Avatar: cfgData.team_leader_3_avatar || prev.teamLeader3Avatar || INITIAL_SITE_CONFIG.teamLeader3Avatar,
            teamLeader4Name: cfgData.team_leader_4_name || cfgData.team_leader_4 || prev.teamLeader4Name || INITIAL_SITE_CONFIG.teamLeader4Name,
            teamLeader4Title: cfgData.team_leader_4_title || prev.teamLeader4Title || INITIAL_SITE_CONFIG.teamLeader4Title,
